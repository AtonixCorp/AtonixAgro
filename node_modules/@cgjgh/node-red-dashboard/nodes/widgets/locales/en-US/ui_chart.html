<script type="text/html" data-help-name="ui-chart">
    ...
    <dl class="message-properties">
        ...
        <dt>Type <span class="property-type">Line | Bar | Scatter | Pie | Doughnut</span></dt>
        ...
        <dt>X-Axis Type <span class="property-type">Linear | Categorical | Timescale | Radial</span></dt>
        <dd>
