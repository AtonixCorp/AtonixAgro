.pwa-toast[data-v-e4e2136f]{position:fixed;right:0;bottom:0;margin:16px;padding:12px;border:1px solid #8885;background-color:rgb(var(--v-theme-background));border-radius:4px;z-index:1;text-align:left;box-shadow:3px 4px 5px #8885;display:grid}.pwa-toast .message[data-v-e4e2136f]{margin-bottom:8px}.pwa-toast .buttons[data-v-e4e2136f]{display:flex}.pwa-toast button[data-v-e4e2136f]{border:1px solid #8885;outline:none;margin-right:5px;border-radius:2px;padding:3px 10px}.pwa-toast button.reload[data-v-e4e2136f]{display:block}.nrdb-debug-view{margin:12px;max-width:1200px}.nrdb-debug-view h1{display:flex;flex-direction:row;align-items:center;justify-content:space-between}.nrdb-debug-description{font-size:.85rem;padding:16px}.debug-filters{display:flex;flex-direction:row;align-items:center;justify-content:flex-start;margin:16px}.debug-filters label{margin-right:1rem}.debug-filters-chips{display:flex;gap:8px;align-items:center}.nested-table,.nested-table .v-table{background-color:#eee}.stack-view[data-v-b5941961]{display:flex;flex-direction:column;gap:10px}.rounded-lg[data-v-b5941961]{border-radius:12px!important}.status-wrapper[data-v-542d8ce2]{display:flex;justify-content:center;align-items:center;position:relative;height:100%;width:30px}.reload-icon[data-v-542d8ce2],.status-indicator[data-v-542d8ce2]{position:absolute;top:50%;left:50%}.reload-icon[data-v-542d8ce2]{font-size:30px;animation:blinkIcon-542d8ce2 4s infinite;transform:translate(-50%,-50%);z-index:2}.status-indicator-red[data-v-542d8ce2]{width:20px;height:20px;border-radius:50%;z-index:1;animation:blinkIndicator-542d8ce2 4s infinite}.status-indicator-green[data-v-542d8ce2]{width:20px;height:20px;border-radius:50%;z-index:0}.dark-theme[data-v-542d8ce2]{color:#fff}@keyframes blinkIcon-542d8ce2{0%,to{opacity:1}50%{opacity:0}}@keyframes blinkIndicator-542d8ce2{0%,to{opacity:0}50%{opacity:1}}.nrdb-ui-notification{padding-top:64px}.nrdb-ui-notification .v-snackbar__wrapper{background-color:rgb(var(--v-theme-group-background));color:rgb(var(--v-theme-on-group-background));border-left:6px solid var(--nrdb-ui-notification-color);min-width:auto}.nrdb-ui-notification .v-snackbar__content{padding:8px 12px}.nrdb-ui-notification-countdown{position:absolute;width:calc(100% + 6px);top:0;left:0;margin-left:-6px;border-top-left-radius:4px}.nrdb-ui-notification h1,.nrdb-ui-notification h2,.nrdb-ui-notification h3,.nrdb-ui-notification h4{margin:.5rem 0}[data-v-3d4d090f] .v-field--variant-outlined{--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}.nrdb-layout-group--grid[data-v-3d4d090f]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;gap:var(--widget-gap)}.nrdb-layout--flex[data-v-3d4d090f]{--layout-card-width: 320px;--layout-gap: 12px;--layout-columns: 100}.nrdb-layout--flex[data-v-3d4d090f]{display:flex;flex-wrap:wrap;padding:var(--page-padding);gap:var(--group-gap)}.nrdb-layout--flex>div[data-v-3d4d090f]{max-width:100%}.v-card[data-v-3d4d090f]{width:100%}@media only screen and (max-width: 576px){.nrdb-layout--flex[data-v-3d4d090f]{--layout-columns: 3}}[data-v-727ec4e9] .v-field--variant-outlined{--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}.nrdb-layout-group--grid[data-v-727ec4e9]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;gap:var(--widget-gap)}.nrdb-layout--grid[data-v-727ec4e9]{--layout-card-width: 320px;--layout-gap: 12px}.nrdb-layout--grid[data-v-727ec4e9]{--layout-columns: var(--78099e59);display:grid;grid-template-columns:repeat(var(--layout-columns),1fr);flex-wrap:wrap;padding:var(--page-padding);gap:var(--group-gap)}.nrdb-layout--grid>div[data-v-727ec4e9]{width:100%}.v-card[data-v-727ec4e9]{width:100%}[data-v-922fb846] .v-field--variant-outlined{--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}.nrdb-layout-group--grid[data-v-922fb846]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;gap:var(--widget-gap)}.nrdb-layout--notebook[data-v-922fb846]{--layout-card-width: 1024px;--layout-gap: 12px}.nrdb-layout--notebook[data-v-922fb846]{margin:auto;width:100%;max-width:var(--layout-card-width);min-height:100%;flex-wrap:wrap;padding:var(--page-padding);--layout-columns: var(--2e6743a2)}.nrdb-layout--notebook>div[data-v-922fb846]{width:100%;margin-bottom:var(--group-gap)}.v-card[data-v-922fb846]{width:100%}[data-v-8243b6f0] .v-field--variant-outlined{--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}.nrdb-layout-group--grid[data-v-8243b6f0]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;gap:var(--widget-gap)}.nrdb-layout--tabs[data-v-8243b6f0]{--layout-gap: 12px;--widget-row-height: 48px;--layout-columns: var(--729c99a0);padding:var(--page-padding)}.v-card[data-v-8243b6f0]{width:100%}.nrdb-ui-button--icon .v-btn__append{margin-left:0;margin-inline:initial}.nrdb-ui-button--icon .v-btn__prepend{margin-right:0;margin-inline:initial}.nrdb-ui-button .v-btn .v-icon{--v-icon-size-multiplier: 1}.nrdb-ui-button .nrdb-ui-button--icon .v-icon{--v-icon-size-multiplier: 1.1}.nrdb-ui-button-group-wrapper{display:flex;flex-direction:row;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px}.nrdb-ui-button-group-wrapper .v-chip__content{white-space:normal}.nrdb-ui-button-group-wrapper .v-btn-group{width:max-content;border-width:thin;border-color:rgba(var(--v-border-color),var(--v-border-opacity))}.nrdb-ui-button-group-wrapper .v-btn--variant-elevated{color:rgb(var(--v-theme-on-group-background));background-color:rgb(var(--v-theme-group-background))}.nrdb-ui-button-group-wrapper .v-btn--variant-elevated{--v-activated-opacity: 0}.nrdb-ui-button-group-wrapper .icon-only .v-btn__prepend{margin-inline:0}.nrdb-ui-button-group-wrapper .v-btn.v-btn--disabled .v-btn__overlay{opacity:.1}.nrdb-ui-button-group-wrapper .v-btn-group .v-btn--disabled .v-btn__content{color:rgb(var(--v-theme-on-group-background),var(--v-disabled-opacity))}.nrdb-ui-chart-placeholder[data-v-d82d1b9e]{position:absolute;display:flex;justify-content:center;align-items:center;top:0;width:100%;height:100%;color:rgba(var(--v-theme-on-group-background),var(--v-disabled-opacity));--pie-slice-1: rgba(var(--v-theme-on-group-background), .05);--pie-slice-2: rgba(var(--v-theme-on-group-background), .1);background:radial-gradient(circle closest-side,rgb(var(--v-theme-group-background)) 50%,transparent 0),radial-gradient(circle closest-side,transparent 66%,rgb(var(--v-theme-group-background)) 0),conic-gradient(var(--pie-slice-1) 0,var(--pie-slice-1) 38%,var(--pie-slice-2) 0,var(--pie-slice-2) 61%)}.nrdb-ui-file-input{display:flex;gap:12px}.nrdb-ui-file-input .v-btn{max-height:var(--widget-row-height)}.nrdb-ui-file-input--progress{width:100%;display:flex;align-items:center}.nrdb-ui-file-input--uploaded{flex-grow:1;display:flex;align-items:center;justify-content:flex-start;gap:6px;height:var(--widget-row-height)}.nrdb-ui-gauge-battery--container[data-v-ff11b7eb]{display:flex;flex-direction:column}.nrdb-ui-gauge-battery[data-v-ff11b7eb]{--battery-margin: 12px;--battery-radius: 12px;--battery-border: 8px;border-radius:var(--battery-radius);border-width:var(--battery-border);padding:6px;border-color:var(--gauge-fill);border-style:solid;flex-grow:1;position:relative}.nrdb-ui-gauge-battery--horizontal[data-v-ff11b7eb]{margin-right:var(--battery-margin)}.nrdb-ui-gauge-battery--vertical[data-v-ff11b7eb]{margin-top:var(--battery-margin)}.nrdb-ui-gauge-battery-icon[data-v-ff11b7eb]{position:absolute;width:100%;height:100%;display:flex;justify-content:center;align-items:center;fill-opacity:.25}.nrdb-ui-gauge-battery-icon.nrdb-ui-gauge-battery-icon--bg[data-v-ff11b7eb]{color:#000}.nrdb-ui-gauge-battery-icon.nrdb-ui-gauge-battery-icon--fill[data-v-ff11b7eb]{color:#fff}.nrdb-ui-gauge-battery-labels[data-v-ff11b7eb]{position:relative;width:100%;height:100%;display:flex;justify-content:center;align-items:center;container-type:size}.nrdb-ui-gauge-battery label[data-v-ff11b7eb]{font-weight:700;resize:both;font-size:min(2.5rem,max(25cqmin,.5rem));position:relative;z-index:2;width:100%;height:100%;text-align:center;white-space:nowrap}.nrdb-ui-gauge-battery label.nrdb-ui-gauge-battery--fglabel[data-v-ff11b7eb]{clip-path:url(#clip)}.nrdb-ui-gauge-battery label.nrdb-ui-gauge-battery--bglabel[data-v-ff11b7eb]{color:rgb(var(--v-theme-on-group-background));position:absolute;left:0;top:0;z-index:1}.nrdb-ui-gauge-battery--center[data-v-ff11b7eb]{display:flex;justify-content:center;align-items:center;height:100%;position:relative}.nrdb-ui-gauge-battery--fill[data-v-ff11b7eb]{background-color:var(--gauge-fill)}.nrdb-ui-gauge-battery svg[data-v-ff11b7eb]{top:0}.nrdb-ui-gauge-battery svg[data-v-ff11b7eb],.nrdb-ui-gauge-battery--fill[data-v-ff11b7eb]{position:absolute;left:0}.nrdb-ui-gauge-battery--horizontal svg[data-v-ff11b7eb],.nrdb-ui-gauge-battery--horizontal .nrdb-ui-gauge-battery--fill[data-v-ff11b7eb]{top:0;height:100%;width:var(--gauge-fill-pc)}.nrdb-ui-gauge-battery--vertical svg[data-v-ff11b7eb],.nrdb-ui-gauge-battery--vertical .nrdb-ui-gauge-battery--fill[data-v-ff11b7eb]{bottom:0;height:var(--gauge-fill-pc);width:100%}.nrdb-ui-gauge-battery[data-v-ff11b7eb]:after{content:"";background-color:var(--gauge-fill);display:block;position:absolute}.nrdb-ui-gauge-battery--horizontal[data-v-ff11b7eb]:after{width:var(--battery-margin);height:40%;top:30%;right:calc(-1 * var(--battery-margin) - var(--battery-border));border-top-right-radius:calc(var(--battery-radius) * .5);border-bottom-right-radius:calc(var(--battery-radius) * .5)}.nrdb-ui-gauge-battery--vertical[data-v-ff11b7eb]:after{width:40%;height:var(--battery-margin);top:calc(-1 * var(--battery-margin) - var(--battery-border));right:30%;border-top-left-radius:calc(var(--battery-radius) * .5);border-top-right-radius:calc(var(--battery-radius) * .5)}.nrdb-ui-gauge-battery-icon svg[data-v-ff11b7eb]{width:40%;height:40%;position:relative}.nrdb-ui-gauge-battery--horizontal .nrdb-ui-gauge-battery-icon svg[data-v-ff11b7eb]{height:80%}.nrdb-ui-gauge svg{flex-grow:1;max-width:100%;position:relative}.nrdb-ui-gauge-title{display:block;text-align:center;font-weight:700;font-size:1rem;padding-bottom:4px}.nrdb-ui-gauge-value{position:absolute;width:100%;height:100%;display:flex;align-content:center;justify-content:center;flex-direction:column;text-align:center;flex-wrap:wrap;padding-top:12px;container-type:size}.nrdb-ui-gauge-value span{font-weight:700}.nrdb-ui-gauge-value label{display:flex;align-items:center;justify-content:center}.nrdb-ui-gauge #backdrop path{fill:rgb(var(--v-theme-background))}.nrdb-ui-gauge #sections path{stroke:rgb(var(--v-theme-group-background));stroke-width:2px}.nrdb-ui-gauge #limits{opacity:.5;fill:rgb(var(--v-theme-on-group-background));container-type:size}.nrdb-ui-gauge #limits text{font-size:min(1rem,max(2cqmin,.8rem))}.nrdb-ui-gauge #needle-container{pointer-events:none}.nrdb-ui-gauge #needle-mask{opacity:0}.nrdb-ui-gauge #needle circle,.nrdb-ui-gauge #needle polygon{fill:rgb(var(--v-theme-on-group-background))}.nrdb-ui-gauge-value span{font-size:2rem;line-height:2.25rem}.nrdb-ui-gauge-value label{font-size:.75rem;line-height:.825rem;gap:4px}.nrdb-ui-gauge-icon-only i{font-size:1.75em}.nrdb-ui-gauge-size-xxs .nrdb-ui-gauge-value,.nrdb-ui-gauge-size-xxs #limits{visibility:hidden}.nrdb-ui-gauge-size-xs .nrdb-ui-gauge-value span{font-size:min(1.5rem,max(2cqmin,.8rem));line-height:min(1.5rem,max(2cqmin,1rem))}.nrdb-ui-gauge-size-xs .nrdb-ui-gauge-value{font-size:min(.75rem,max(2cqmin,.5rem));line-height:min(.825rem,max(2cqmin,.65rem))}.nrdb-ui-gauge-size-sm .nrdb-ui-gauge-value span{font-size:2rem;line-height:2.25rem}.nrdb-ui-gauge-size-md .nrdb-ui-gauge-value span{font-size:2.5rem;line-height:3rem}.nrdb-ui-gauge-size-md .nrdb-ui-gauge-value label{font-size:1rem;line-height:1.25rem}.nrdb-ui-gauge-size-lg .nrdb-ui-gauge-value span{font-size:3rem;line-height:3.25rem}.Wave[data-v-34690e1c],.WaveBG[data-v-34690e1c]{width:200%;position:absolute;overflow:visible;animation-name:swell-34690e1c;animation-fill-mode:forwards;animation-iteration-count:infinite;animation-timing-function:linear;fill:var(--gauge-fill);bottom:var(--gauge-fill-pc)}.WaveBG[data-v-34690e1c]{opacity:.4;animation-duration:1.5s;animation-delay:1.2s}.Wave[data-v-34690e1c]{animation-duration:2s}@keyframes swell-34690e1c{0%{transform:scaleX(2) translate(25%) translateY(1px)}to{transform:scaleX(2) translate(-25%) translateY(1px)}}.nrdb-ui-gauge-tank--container[data-v-34690e1c]{display:flex;flex-direction:column;container:tank-container / size}.nrdb-ui-gauge-tank[data-v-34690e1c]{--tank-margin: 6px;--tank-padding: 3px;--tank-radius: 6px;--tank-border: 4px}@container tank-container (min-width: 75px) and (min-height: 75px){.nrdb-ui-gauge-tank[data-v-34690e1c]{--tank-margin: 12px;--tank-radius: 12px;--tank-border: 8px;--tank-padding: 6px}}.nrdb-ui-gauge-tank[data-v-34690e1c]{border-radius:var(--tank-radius);border-width:var(--tank-border);padding:var(--tank-padding);border-color:var(--gauge-fill);border-style:solid;flex-grow:1;position:relative}.nrdb-ui-gauge-tank--fill[data-v-34690e1c]{background-color:transparent}.nrdb-ui-gauge-tank-labels[data-v-34690e1c]{position:relative;width:100%;height:100%;display:flex;justify-content:center;align-items:center;container-type:size}.nrdb-ui-gauge-tank label[data-v-34690e1c]{font-weight:700;resize:both;font-size:min(2.5rem,50cqmin);position:relative;z-index:2;width:100%;height:100%;text-align:center;white-space:nowrap;color:#000;--text-border: 1px;--text-border-inv: -1px ;--text-border-color: white;text-shadow:var(--text-border) var(--text-border-inv) var(--text-border-color),var(--text-border-inv) var(--text-border-inv) var(--text-border-color),var(--text-border-inv) var(--text-border) var(--text-border-color),var(--text-border) var(--text-border) var(--text-border-color)}.nrdb-ui-gauge-tank--center[data-v-34690e1c]{display:flex;justify-content:center;align-items:center;height:100%;position:relative;overflow:hidden}.nrdb-ui-gauge-tank svg.mask[data-v-34690e1c]{top:0}.nrdb-ui-gauge-tank svg.mask[data-v-34690e1c],.nrdb-ui-gauge-tank--fill[data-v-34690e1c]{position:absolute;left:0}.nrdb-ui-gauge-tank--fill[data-v-34690e1c]{bottom:0;height:var(--gauge-fill-pc);width:100%}.nrdb-ui-gauge-tile[data-v-866c29e0]{display:flex;justify-content:center;align-items:center;container-type:size;font-weight:700;transition:.15s background-color;border:1px solid rgb(var(--v-theme-group-outline))}.nrdb-ui-gauge-tile label[data-v-866c29e0]{font-size:min(2.5rem,max(40cqmin,.5rem));text-align:center}.nrdb-ui-gauge{position:relative}/*!
  Theme: Default
